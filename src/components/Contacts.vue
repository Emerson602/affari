   ...
   <div id="contacts-container" class="text-center pt-5">
    ...
    <section class="d-flex flex-column justify-content-center align-items-center flex-wrap">
        ...
        <div id="contacts" class="pt-5 pb-5 d-flex flex-row justify-content-center align-items-center flex-wrap">
            ...
            <a href="https://api.whatsapp.com/send?phone=SEUNUMERODETELEFONE" class="column fs-5 m-3 p-2 rounded fs-5" id="btn-whatsapp" title="Contate-nos via WhatsApp" aria-label="Contate-nos via WhatsApp">
            ...
            <a href="" class="column fs-5 m-3 p-2 rounded fs-5" id="btn-instagram" title="Contate-nos via WhatsApp" aria-label="Contate-nos via WhatsApp">
